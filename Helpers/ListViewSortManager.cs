...
namespace EV.Windows.Forms
{
    ...
    public class ListViewSortManager
    {
        ...
        public void Sort(Int32 column, SortOrder order)
        {
            ...
            {
                var comp = (ListViewTextSort)Activator.CreateInstance(m_comparers[m_column],
                    new Object[] { m_column, m_sortOrder == SortOrder.Ascending });
            ...
            set
            {
                if (value)
                {
                    if (!this.SortEnabled)
                    {
                        ...
                        m_list.ListViewItemSorter = (ListViewTextSort)Activator.CreateInstance(m_comparers[m_column],
                            new Object[] { m_column, m_sortOrder == SortOrder.Ascending });
