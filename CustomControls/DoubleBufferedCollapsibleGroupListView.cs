...
namespace RIS
{
    /// <inheritdoc />
    /// <summary>
    /// A custom double-buffered listview that supports collapsible groups.
    /// </summary>
    public class DoubleBufferedCollapsibleGroupListView : ListView
    {
        ...
        public DoubleBufferedCollapsibleGroupListView()
            : base()
        {
